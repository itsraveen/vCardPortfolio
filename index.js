...
var learnmorebtn = document.querySelector(".linked-in").addEventListener("click", handleLearnMoreBtn)
...
var dscnusbtn = document.querySelector(".linkedin").addEventListener("click", handleLinkedInBtn)

function handleLinkedInBtn(){
    window.location.href = "http://www.linkedin.com/in/raveenprabhu"
}
